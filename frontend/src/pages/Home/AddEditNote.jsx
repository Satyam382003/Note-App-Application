    ...
    <div className='relative'>
      ...
      <div className='flex flex-col gap-1'>
       <label className='input-label'>TITLE</label>
        <input
         type='text'
         className='text-base text-slate-950 outline-none border border-slate-300 rounded px-2 py-2'
         placeholder='Go to gym at 11am'
         value={title}
      ...
      <textarea
      className='text-sm text-slate-950 outline-none bg-slate-50 border border-slate-300 rounded p-2'
      placeholder='Content'
      rows={10}
      value={content}
